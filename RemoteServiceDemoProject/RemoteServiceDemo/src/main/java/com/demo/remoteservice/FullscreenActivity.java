package com.demo.remoteservice;

import com.demo.remoteservice.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button localButton = (Button) findViewById(R.id.localService_button);
        Button remoteButton = (Button) findViewById(R.id.remoteService_button);
        ...
        localButton.setOnTouchListener(mDelayHideTouchListener);
